...
public class CameraSource {
    ...
    public CameraSource start(CameraSource mCameraSource, GraphicOverlay<BarcodeGraphic> mGraphicOverlay) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     * <p/>
     * This camera source may be restarted again by calling {@link #start(CameraSource, GraphicOverlay)} or
     ...
     * activated previously with {@link #start(CameraSource, GraphicOverlay)} or {@link #start(SurfaceHolder)}.  The camera
     ...
     * (between {@link #start(CameraSource, GraphicOverlay)} or {@link #start(SurfaceHolder)} and before {@link #stop()} or {@link #release()}).
     * <p/>
